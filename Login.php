...
<![endif]-->
    ...
    <body class="login-page">
        ...
        <div id="login" class="animated bounceIn">
            <img id="logo" src="assets/img/logo.gif"  width="210" height="50" alt="sprFlat Logo">
            <!-- Start .login-wrapper -->
            <div class="login-wrapper">
                ...
                <div id="myTabContent" class="tab-content bn">
                    <div class="tab-pane fade active in" id="log-in"> 
                        <form class="form-horizontal mt10" action="auth.php" id="login-form" role="form" method="post">
                            <div class="form-group">
                                <div class="col-lg-12">
                                    <input type="text" name="username" id="email" class="form-control left-icon"  placeholder="Your account ...">
                            ...
                            <div class="form-group">
                                <div class="col-lg-12">
                                    ...
                                    <span class="help-block"><a href="#"><small>忘記密碼?</small></a></span> 
                                </div>
                            </div>
